...
// Search books
$searchResults = $bookOps->searchBooks($query, $category, $authorFilter, $sortBy, $sortOrder, $page, $perPage);
...
if (!empty($authorFilter)) {
    $baseUrl .= 'author=' . urlencode($authorFilter) . '&';
}
...
<div class="container py-4 fade-in">
    ...
    <div class="row">
        <div class="col-12">
            <?php if (empty($query) && empty($category) && empty($authorFilter)): ?>
